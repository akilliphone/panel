        ...
        <div class="container-fluid h-100">
            ...
            <div class="navbar-right d-flex justify-content-end justify-content-lg-between">
                <div class="searchbar d-none d-lg-flex">
                    <img src="<?php echo e(asset('assets/images/search.svg')); ?>" alt="searchbar">
                    <input placeholder="Ne Aramıştınız?" type="text">
                </div>
                <div class="user-section">
                    <ul class="user-links">
                        <li class="user-link"><a class="position-relative" href="#">
                        ...
                        <li class="user-link mobile-user">
                            <a href="#"><?php echo e($userAbb); ?></a>
                        </li>
                        <li class="user-link desktop-user">
                            <a href="#"><?php echo e($username); ?></a>
                        </li>
                    </ul>
...
<!-- NAVBAR END -->
<?php /**PATH C:\Users\x\Desktop\Folders\AkilliPhone\akillipanel\resources\views/sections/Navbar.blade.php ENDPATH**/ ?>